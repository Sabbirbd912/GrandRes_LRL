            ...
            <div class="widget-stat card" style="background-color:#FF5F8A; background: linear-gradient(to right,rgb(228, 152, 117),#FF5F8A);">
                <div class="card-body p-4">
                    <div class="media ai-icon">
                        ...
                        <div class="media-body">
                            <h3 class="mb-0 text-black"><span class="counter ml-0">{{$count}}</span>Pr</h3>
            ...
            <div class="card">
                ...
                <div class="card-body orders-summary">
                    <div class="d-flex order-manage p-3 align-items-center mb-4">
                        ...
                        <h4 class="mb-0">New Orders <i class="fa fa-circle text-success ml-1 fs-15"></i>
                        </h4>
                        <a href="javascript:void(0);" class="ml-auto text-primary font-w500">Manage orders
                ...
                <div class="card-body revenue-chart px-3">
                    <div class="d-flex align-items-end pr-3 pull-right revenue-chart-bar">
                        <div class="d-flex align-items-end mr-4">
                            <img src="./images/svg/ic_stat2.svg" height="22" width="22" class="mr-2 mb-1"
                                alt="" />
                            <div>
                        ...
                        <div class="d-flex align-items-end">
                            <img src="./images/svg/ic_stat1.svg" height="22" width="22" class="mr-2 mb-1"
                                alt="" />
                            <div>
