                ...
                <tbody>
                    @forelse ($details as $detail)
                        <tr class="text-black dark__bg-1000">
                            ...
                            <td class="border-0 text-end">{{ number_format($detail->qty * $detail->price, 2) }}</td>
                        </tr>
                    @empty
                        <tr>
            ...
            <div class="col-md-4">
                <table class="table table-borderless text-end">
                    <tr>
                        ...
                        <td id="subTotal" class="fw-bold">{{ $sub_total= number_format($detail->qty * $detail->price, 2) }}</td>
                    </tr>
                    <tr>
                        <th class="text-muted">Discount (5%):</th>
                        <td id="discount" class="fw-bold">{{ $dis=$sub_total*0.95, 2 }}</td>
                    </tr>
                    <tr>
                        <th class="text-muted">Tax (3%):</th>
                        <td id="tax" class="fw-bold">{{ $tax= $dis*1.03, 2 }}</td>
                    </tr>
                    <tr class="border-top">
                        <th class="text-dark">Total:</th>
                        <td id="netTotal" class="fw-bold text-dark">{{$tax}}</td>
                    </tr>
