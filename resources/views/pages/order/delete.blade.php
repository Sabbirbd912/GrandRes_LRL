...
<div class="container mt-5 d-flex justify-content-center">
  <div class="card border-danger shadow-sm w-100" style="max-width: 420px;">
    ...
    <div class="card-body text-center">
      ...
      <h5 class="text-danger fw-bold">{{ $order->id }}</h5>

      <form action="{{ url('orders/' . $order->id) }}" method="POST" class="mt-4 d-inline-block me-2">
        @csrf
        @method("DELETE")
      ...
      <a href="{{ url('orders') }}" class="btn btn-sm btn-secondary px-3">
