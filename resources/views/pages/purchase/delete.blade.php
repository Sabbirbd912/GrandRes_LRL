...
<div class="container mt-5 d-flex justify-content-center">
  <div class="card border-danger shadow-sm w-100" style="max-width: 420px;">
    ...
    <div class="card-body text-center">
      ...
      <h5 class="text-danger fw-bold">{{ $purchase?->supplier_id ?? 'N/A' }}</h5>
      <form action="{{ url('purchases/' . $purchase->id) }}" method="POST" class="mt-4 d-inline-block me-2">
        @csrf
        @method("DELETE")
      ...
      <a href="{{ url('purchases') }}" class="btn btn-sm btn-secondary px-3">
